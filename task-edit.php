<?php
ob_start(); // Fix header warning - ONLY ADDED LINE
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    // FIX: Convert empty strings to NULL for database
    ...
    $actual_hours = (!empty($_POST['actual_hours']) && $_POST['actual_hours'] > 0) ? floatval($_POST['actual_hours']) : null;
    ...
    if ($task_obj->update($task_id, $data)) {
        ob_end_clean(); // FIX: Clear buffer before redirect
