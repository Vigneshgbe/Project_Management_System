...
<?php if ($view_email['opened_count'] > 0): ?>
    <span style="font-size:12px;color:var(--green);font-weight:600">
      👁 Opened <?= $view_email['opened_count'] ?> time<?= $view_email['opened_count']>1?'s':'' ?>
      <?= $view_email['opened_at'] ? ' · '.date('M j g:ia',strtotime($view_email['opened_at'])) : '' ?>
    </span>
    <?php endif; ?>
