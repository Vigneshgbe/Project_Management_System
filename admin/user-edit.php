...
<div class="user-edit-container">
    ...
    <div class="content-wrapper">
        ...
        <div class="user-info-card">
            ...
            <div class="info-section">
                ...
                <div class="info-item">
                    ...
                    <div class="info-item-content">
                        ...
                        <div class="info-item-value"><?php echo htmlspecialchars($user['username']); ?></div>
                    </div>
                </div>
                <div class="info-item">
            ...
            <div class="info-section">
                <div class="info-section-title">
                    <i class="fa fa-shield"></i> Security Note
                </div>
                <div class="info-item">
                    <i class="fa fa-lock"></i>
                    <div class="info-item-content">
                        <div class="info-item-value" style="font-size: 12px; line-height: 1.5;">
